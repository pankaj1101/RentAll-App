...
//        holder.textView1.setText(String.valueOf(messagesArrayList.get(position).getPrice()));
//        holder.textView2.setText(String.valueOf(messagesArrayList.get(position).getRefund()));
//        Glide.with(mContext).load(messagesArrayList.get(position).getImageUrl()).into(holder.imageView);
//
//        //Finding Total Amount of product...
//        total_amount = total_amount + (messagesArrayList.get(position).getPrice()) +
//                messagesArrayList.get(position).getRefund();
//
